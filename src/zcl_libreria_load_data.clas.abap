...
CLASS zcl_libreria_load_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ_67.
...
**********
    ...
    DELETE FROM ztb_acc_categ_67.
    INSERT ztb_acc_categ_67 FROM TABLE @lt_acc_categ.
    out->write( 'Registros insertados' && ` ` && sy-dbcnt && ` ` && 'tabla ztb_acc_categ_67' ).
...
**********
    ...
    DATA: lt_categorias TYPE STANDARD TABLE OF ztb_catego_6741.
    ...
    DELETE FROM ztb_catego_6741.
    INSERT ztb_catego_6741 FROM TABLE @lt_categorias.
    out->write( 'Registros insertados' && ` ` && sy-dbcnt && ` ` && 'tabla ztb_catego_6741' ).


**********
*TABLA CLIENTES
**********
    DATA: lt_clientes TYPE STANDARD TABLE OF ztb_clientes_67.
    ...
    DELETE FROM ztb_clientes_67.
    INSERT ztb_clientes_67 FROM TABLE @lt_clientes.
    out->write( 'Registros insertados' && ` ` && sy-dbcnt && ` ` && 'tabla ztb_clientes_67' ).

**********
*TABLA CLIENTES-LIBROS
**********

    DATA: lt_CLI_LIB TYPE STANDARD TABLE OF ztb_clnts_lib_67.
...
( id_cliente = '540867547H' id_libro = '000020' ) ).
    ...
    DELETE FROM ztb_clnts_lib_67.
    INSERT ztb_clnts_lib_67 FROM TABLE @lt_CLI_LIB.
    out->write( 'Registros insertados' && ` ` && sy-dbcnt && ` ` && 'tabla ztb_clnts_lib_67' ).


**********
*TABLA LIBROS
**********
    DATA: lt_libros TYPE STANDARD TABLE OF ztb_libros_67.
    ...
    DELETE FROM ztb_libros_67.
    INSERT ztb_libros_67 FROM TABLE @lt_libros.

    out->write( 'Registros insertados' && ` ` && sy-dbcnt && ` ` && 'tabla ztb_libros_67' ).
